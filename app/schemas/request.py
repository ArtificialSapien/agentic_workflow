...
class InitialRequest(BaseModel):
    ...
    generate_image: bool = Field(default = False, description="Flag whether generate image")
    generate_video: bool = Field(default = False, description="Flag whether generate video")
...
class FineTuneRequest(BaseModel):
    ...
    # session_id: str = Field(description="The session ID") # Potential field to add
    prompt: str = Field(description="The prompt")
    generated_text: str = Field(description="The generated text component of the social media post")
